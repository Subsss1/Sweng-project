...
#Get argument that specifies the path of the file to be read.
file_path = sys.argv[1:2]
...
# Call the locally trained model
model = joblib.load('binary_class_model/model.pkl')
